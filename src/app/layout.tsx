    ...
    <>
      ...
      <main style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
        ...
        <nav style={{
          ...
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 16 }}>Lachlan McCreanney's Portfolio</span>
